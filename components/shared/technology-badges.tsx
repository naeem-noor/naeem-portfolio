 ...
 * Shared by Experience's `CompanyCard` (environment + tech stack) and
 * Projects' `ProjectCard`/`ProjectCaseStudy` (tech stack) — the only
 * difference between every use is the data passed in.
 */
